...
Output is the same data table with all other columns preserved. If given data completely consisist of Ensembld ID's, please choose Ensembl version of that organism while using `ctype` argument.
